...
//        mZebraList.add(ZbrSetting("음량(Volume)", "비프음 음량 조절"))
        mZebraList.add(ZbrSetting("RS232 전송 속도", "", listOf(R.drawable.zbr9600,R.drawable.zbr19200, R.drawable.zbr38400, R.drawable.zbr57600, R.drawable.zbr115200) ))
        mZebraList.add(ZbrSetting("도서 바코드 ISBN", "EAN13 Add-on", listOf(R.drawable.zbr9600,R.drawable.zbr19200, R.drawable.zbr38400, R.drawable.zbr57600, R.drawable.zbr115200)))
        mZebraList.add(ZbrSetting("[무선] 블루투스 연결", "", listOf(R.drawable.zbr9600,R.drawable.zbr19200, R.drawable.zbr38400, R.drawable.zbr57600, R.drawable.zbr115200)))
        mZebraList.add(ZbrSetting("DPM 모드 & 조명", "DPM 종류별 모드, 조명 설정",listOf(R.drawable.zbr9600,R.drawable.zbr19200, R.drawable.zbr38400, R.drawable.zbr57600, R.drawable.zbr115200)))
        mZebraList.add(ZbrSetting("Polling Interval", "1ms ~ 9ms", listOf(R.drawable.zbr9600,R.drawable.zbr19200, R.drawable.zbr38400, R.drawable.zbr57600, R.drawable.zbr115200)))
        mZebraList.add(ZbrSetting("MP7000 기본 세팅", "",listOf(R.drawable.zbr9600,R.drawable.zbr19200, R.drawable.zbr38400, R.drawable.zbr57600, R.drawable.zbr115200)))
        mZebraList.add(ZbrSetting("[무선]배치 모드", "배치 모드 설정 & 데이터 전송",listOf(R.drawable.zbr9600,R.drawable.zbr19200, R.drawable.zbr38400, R.drawable.zbr57600, R.drawable.zbr115200)))
